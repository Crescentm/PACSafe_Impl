...
define dso_local i32 @main() #0 !dbg !42 {
  ...
  call void @setMetadata(i8** %3, i32 1, i32 24)
  ...
  call void @llvm.dbg.declare(metadata %struct.Bar** %4, metadata !45, metadata !DIExpression()), !dbg !48
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)), !dbg !49
  %6 = call noalias i8* @malloc(i64 noundef 16) #4, !dbg !50
  %7 = bitcast i8* %6 to %struct.Bar*, !dbg !51
  store %struct.Bar* %7, %struct.Bar** %4, align 8, !dbg !52
  %8 = bitcast %struct.Bar** %4 to i8**, !dbg !53
  call void @setMetadataObj(i8** %8, i32 1, i32 16), !dbg !53
  %9 = bitcast %struct.Bar** %4 to i8**, !dbg !53
  call void @addPAC(i8** %9), !dbg !53
  %10 = bitcast %struct.Bar** %4 to i8**, !dbg !53
  call void @authPAC(i8** %10, i32 0), !dbg !53
  %11 = load %struct.Bar*, %struct.Bar** %4, align 8, !dbg !53
  %12 = getelementptr inbounds %struct.Bar, %struct.Bar* %11, i32 0, i32 0, !dbg !54
  store volatile %struct.Foo* %2, %struct.Foo** %12, align 8, !dbg !55
  %13 = bitcast %struct.Foo** %12 to i8**, !dbg !56
  call void @addPAC(i8** %13), !dbg !56
  %14 = bitcast %struct.Foo* %2 to i8**, !dbg !56
  call void @removeMetadataStack(i8** %14), !dbg !56
  ret i32 0, !dbg !56
}
